      ...
      <div className="flex items-center py-5 md:w-1/2 md:pb-20 md:pt-10 md:pr-10">
        <div className="text-left">
          <h2 className="text-4xl font-extrabold leading-10 tracking-tight text-gray-800 sm:text-5xl sm:leading-none md:text-6xl">
            Rick
            <span className="font-bold text-blue-500"> and Morty</span>
            <span className="text-4xl font-semibold rounded-full text-blueGray-500">
               API
            </span>
          </h2>
      ...
      <div className="flex items-center py-5 md:w-1/2 md:pb-20 md:pt-10 md:pl-10">
        <div className="relative w-full p-3 rounded  md:p-8">
          <div className="rounded-lg bg-white text-black w-full">
            <img className='m-2 rounded-2xl' src="https://rickandmortyapi.com/api/character/avatar/2.jpeg" />
            <img className='m-2 rounded-2xl' src={Rick} />
          </div>
        </div>
      </div>
    </div>
